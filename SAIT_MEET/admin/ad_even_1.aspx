<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ad_even_1.aspx.cs" Inherits="admin" %>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Meme Mafia</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Event List</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Meme Mafia</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">                               
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SAIT_MEETConnectionString %>" DeleteCommand="DELETE FROM [even_1] WHERE [id] = @id" InsertCommand="INSERT INTO [even_1] ([first_name], [last_name], [gender], [College_neme], [course], [Department], [Country], [State_name], [City], [Home_Town], [Email], [Mobile_no], [pin_code]) VALUES (@first_name, @last_name, @gender, @College_neme, @course, @Department, @Country, @State_name, @City, @Home_Town, @Email, @Mobile_no, @pin_code)" SelectCommand="SELECT * FROM [even_1]" UpdateCommand="UPDATE [even_1] SET [first_name] = @first_name, [last_name] = @last_name, [gender] = @gender, [College_neme] = @College_neme, [course] = @course, [Department] = @Department, [Country] = @Country, [State_name] = @State_name, [City] = @City, [Home_Town] = @Home_Town, [Email] = @Email, [Mobile_no] = @Mobile_no, [pin_code] = @pin_code WHERE [id] = @id">
                                        <DeleteParameters>
