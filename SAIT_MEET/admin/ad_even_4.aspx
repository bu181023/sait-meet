<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ad_even_4.aspx.cs" Inherits="admin" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">                               
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SAIT_MEETConnectionString %>" DeleteCommand="DELETE FROM [even_4] WHERE [id] = @id" InsertCommand="INSERT INTO [even_3] ([first_name], [last_name], [gender], [College_neme], [course], [Department], [Country], [State_name], [City], [Home_Town], [Email], [Mobile_no], [pin_code]) VALUES (@first_name, @last_name, @gender, @College_neme, @course, @Department, @Country, @State_name, @City, @Home_Town, @Email, @Mobile_no, @pin_code)" SelectCommand="SELECT * FROM [even_4]" UpdateCommand="UPDATE [even_4] SET [first_name] = @first_name, [last_name] = @last_name, [gender] = @gender, [College_neme] = @College_neme, [course] = @course, [Department] = @Department, [Country] = @Country, [State_name] = @State_name, [City] = @City, [Home_Town] = @Home_Town, [Email] = @Email, [Mobile_no] = @Mobile_no, [pin_code] = @pin_code WHERE [id] = @id">
                                        <DeleteParameters>
