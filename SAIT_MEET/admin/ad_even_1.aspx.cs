 ...
 */
        ...
        String sql = "INSERT INTO even_1 VALUES('" + first_name + "','" + last_name + "','" + gender + "','" + college_name + "','" + course + "','" + department + "','" + country_name + "','" + state_name + "','" + city_name + "','" + home_town + "','" + email + "','" + mob_no + "','" + pin_no + "' ) ";
        ...
        Response.Redirect("ad_even_1.aspx");
