<%@ Page Language="C#" AutoEventWireup="true" CodeFile="event_1.aspx.cs" Inherits="event_1" %>
  ...
  <div class="container-fluid">
    ...
    <section id="banner">
        <div class="container ">
            <div class="row">
                <div class="col-md-6">
                   <p class="promo-title">Meme Mafia</p>
                    <p class="">
    ...
    <section class="container">
        <div class="row justify-content-center m-4 p-4">
            <div class="col-md-8">
                <img src="img/event/835814-meme.jpg" class="img-fluid" alt=""  />
            </div>
            </div>
             <div class="row">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="input-group col-lg-3 pt-3 pb-3">
                 ...
                 <div class="input-group col-lg-3 pt-3 pb-3">
                     <div class="p-t-10">
                         <asp:Label CssClass="form-control-lable p-2"  ID="co" runat="server" Text="Course"></asp:Label>
