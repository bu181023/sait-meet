<%@ Page Language="C#" AutoEventWireup="true" CodeFile="event_3.aspx.cs" Inherits="event_1" %>
  ...
  <div class="container-fluid">
    ...
    <section id="banner">
        <div class="container ">
            <div class="row">
                <div class="col-md-6">
                   <p class="promo-title">Just-A-Minute</p>
                    <p class="">
                ...
                <div class="col-md-6 text-center">
                    <img src="img/event/Stopwatch-for-productive-meetings.jpg" class="img-fluid" alt="" />
                </div>
            </div>
        </div>
        <div class="col-12 ">
