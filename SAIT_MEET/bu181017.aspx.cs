...
public partial class event_1 : System.Web.UI.Page
{
    ...
    protected void reg_Click(object sender, EventArgs e)
    {
        ...
        mob_no = mob.Text;
        pin_no = pin.Text;
        SqlConnection con = new SqlConnection(@"Data Source=SURIYA;Initial Catalog=student;Integrated Security=True");
        ...
        String sql = "INSERT INTO even_3 VALUES('" + first_name + "','" + last_name + "','" + gender + "','" + college_name + "','" + course + "','" + department + "','" + country_name + "','" + state_name + "','" + city_name + "','" + home_town + "','" + email + "','" + mob_no + "','" + pin_no + "' ) ";
