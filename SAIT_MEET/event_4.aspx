<%@ Page Language="C#" AutoEventWireup="true" CodeFile="event_4.aspx.cs" Inherits="event_1" %>
  ...
  <div class="container-fluid">
    ...
    <section id="banner">
        <div class="container ">
            <div class="row">
                <div class="col-md-6">
                   <p class="promo-title">Broadcast</p>
                    <p class="">
    ...
    <section class="container">
        <div class="row justify-content-center m-4 p-4">
            <div class="col-md-8">
                <img src="img/event/TV-1.jpg" class="img-fluid" alt=""  />
            </div>
            </div>
             <div class="row">
