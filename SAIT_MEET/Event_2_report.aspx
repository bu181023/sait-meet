<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Event_2_report.aspx.cs" Inherits="Event_1_report" %>
...
<body>
    <form id="form1" runat="server">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
            <LocalReport ReportPath="even_2.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="even_2TableAdapters.even_2TableAdapter" UpdateMethod="Update">
            <DeleteParameters>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="even_2TableAdapters.even_2TableAdapter"></asp:ObjectDataSource>
